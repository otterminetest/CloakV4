...
local function get_formspec(dlgview, name, tabdata_etc)
	...
	if tabdata.selected then
		if gamedata.fav then
			...
			retval = retval .. "image_button[6.87,1.3;0.8,0.8;" .. core.formspec_escape(defaulttexturedir ..
				"server_favorite_delete.png") .. ";btn_delete_favorite;]"
		end
		if gamedata.serverdescription then
			retval = retval .. "textarea[0.6,2.17;7.5,3.5;;;" ..
